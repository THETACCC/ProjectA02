namespace SnapshotShaders.URP
{
    ...
    public class FancyDither : ScriptableRendererFeature
    {
        ...
        {
            var settings = VolumeManager.instance.stack.GetComponent<FancyDitherSettings>();
        ...
        class FancyDitherRenderPass : ScriptableRenderPass
        {
            ...
            {
                profilingSampler = new ProfilingSampler("FancyDither");
            ...
            {
                var shader = Shader.Find("SnapshotProURP/FancyDither");
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                material.SetFloat("_Blend", settings.blendAmount.value);
                ...
                // Perform the Blit operations for the Fancy Dither effect.
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor, "_FancyDitherColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("FancyDither_CopyColor", out var passData, profilingSampler))
                {
                ...
                using (var builder = renderGraph.AddRasterRenderPass<MainPassData>("FancyDither_MainPass", out var passData, profilingSampler))
                {
