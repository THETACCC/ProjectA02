namespace SnapshotShaders.URP
{
    ...
    public class Invert : ScriptableRendererFeature
    {
        ...
        class InvertRenderPass : ScriptableRenderPass
        {
            ...
            public InvertRenderPass()
            {
                profilingSampler = new ProfilingSampler("Invert");
            ...
            {
                var shader = Shader.Find("SnapshotProURP/Invert");

                if (shader == null)
                {
                    Debug.LogError("Cannot find shader: \"SnapshotProURP/Invert\".");
                    return;
                }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                material.SetFloat("_Blend", settings.strength.value);

                RTHandle cameraTargetHandle = renderingData.cameraData.renderer.cameraColorTargetHandle;

                // Perform the Blit operations for the Invert effect.
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor, "_InvertColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("Invert_CopyColor", out var passData, profilingSampler))
                {
                ...
                using (var builder = renderGraph.AddRasterRenderPass<MainPassData>("Invert_MainPass", out var passData, profilingSampler))
                {
