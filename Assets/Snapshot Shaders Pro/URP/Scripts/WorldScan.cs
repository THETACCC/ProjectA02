namespace SnapshotShaders.URP
{
    ...
    public class WorldScan : ScriptableRendererFeature
    {
        ...
        class WorldScanRenderPass : ScriptableRenderPass
        {
            ...
            public WorldScanRenderPass()
            {
                profilingSampler = new ProfilingSampler("WorldScan");
            ...
            {
                var shader = Shader.Find("SnapshotProURP/WorldScan");

                if (shader == null)
                {
                    Debug.LogError("Cannot find shader: \"SnapshotProURP/WorldScan\".");
                    return;
                }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                material.SetFloat("_ScanDist", settings.scanDistance.value);
