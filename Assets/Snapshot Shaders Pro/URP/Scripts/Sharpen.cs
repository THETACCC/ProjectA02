namespace SnapshotShaders.URP
{
    ...
    public class Sharpen : ScriptableRendererFeature
    {
        ...
        class SharpenRenderPass : ScriptableRenderPass
        {
            ...
            {
                profilingSampler = new ProfilingSampler("Sharpen");
            ...
            {
                var shader = Shader.Find("SnapshotProURP/Sharpen");

                if (shader == null)
                {
                    Debug.LogError("Cannot find shader: \"SnapshotProURP/Sharpen\".");
                    return;
                }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                // Perform the Blit operations for the Sharpen effect.
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor, "_SharpenColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("Sharpen_CopyColor", out var passData, profilingSampler))
                {
                ...
                using (var builder = renderGraph.AddRasterRenderPass<MainPassData>("Sharpen_MainPass", out var passData, profilingSampler))
                {
