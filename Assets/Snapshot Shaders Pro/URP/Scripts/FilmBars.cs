namespace SnapshotShaders.URP
{
    ...
    public class FilmBars : ScriptableRendererFeature
    {
        ...
        {
            var settings = VolumeManager.instance.stack.GetComponent<FilmBarsSettings>();
        ...
        class FilmBarsRenderPass : ScriptableRenderPass
        {
            ...
            {
                profilingSampler = new ProfilingSampler("FilmBars");
            ...
            {
                var shader = Shader.Find("SnapshotProURP/FilmBars");
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                // Set Film Bars effect properties.
                var settings = VolumeManager.instance.stack.GetComponent<FilmBarsSettings>();
                renderPassEvent = settings.renderPassEvent.value;
                material.SetFloat("_Aspect", settings.aspect.value);

                RTHandle cameraTargetHandle = renderingData.cameraData.renderer.cameraColorTargetHandle;

                // Perform the Blit operations for the FilmBars effect.
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor, "_FilmBarsColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("FilmBars_CopyColor", out var passData, profilingSampler))
                {
                ...
                using (var builder = renderGraph.AddRasterRenderPass<MainPassData>("FilmBars_MainPass", out var passData, profilingSampler))
                {
