namespace SnapshotShaders.URP
{
    ...
    public class BarrelDistortion : ScriptableRendererFeature
    {
        ...
        {
            var settings = VolumeManager.instance.stack.GetComponent<BarrelDistortionSettings>();
        ...
        class BarrelDistortionRenderPass : ScriptableRenderPass
        {
            ...
            {
                profilingSampler = new ProfilingSampler("BarrelDistortion");
            ...
            {
                var shader = Shader.Find("SnapshotProURP/BarrelDistortion");
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor, "_BarrelDistortionColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("BarrelDistortion_CopyColor", out var passData, profilingSampler))
                {
                ...
                using (var builder = renderGraph.AddRasterRenderPass<MainPassData>("BarrelDistortion_MainPass", out var passData, profilingSampler))
                {
