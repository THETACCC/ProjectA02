namespace SnapshotShaders.URP
{
    ...
    public class Silhouette : ScriptableRendererFeature
    {
        ...
        class SilhouetteRenderPass : ScriptableRenderPass
        {
            ...
            {
                profilingSampler = new ProfilingSampler("Silhouette");
            ...
            {
                var shader = Shader.Find("SnapshotProURP/Silhouette");

                if (shader == null)
                {
                    Debug.LogError("Cannot find shader: \"SnapshotProURP/Silhouette\".");
                    return;
                }
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                // Perform the Blit operations for the Silhouette effect.
            ...
            public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
            {
                ...
                copiedColor = UniversalRenderer.CreateRenderGraphTexture(renderGraph, colorCopyDescriptor, "_SilhouetteColorCopy", false);

                using (var builder = renderGraph.AddRasterRenderPass<CopyPassData>("Silhouette_CopyColor", out var passData, profilingSampler))
                {
