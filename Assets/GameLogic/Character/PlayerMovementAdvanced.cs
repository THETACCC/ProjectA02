...
public class PlayerMovementAdvanced : MonoBehaviour
{
    ...
    private void MyInput()
    {
        ...
        if( horizontalInput == 1)
        {
            ...
            //Vector3 newO = new Vector3(, 0, 0);
            //Vector3 newO = orientation.forward * verticalInput + orientation.right * horizontalInput;
            //Debug.Log(newO);
            //orientation.forward = Vector3.Slerp(orientation.forward, newO, Time.deltaTime * rotationSpeed);
            //this.gameObject.transform.forward = Vector3.Slerp(this.gameObject.transform.forward, newO, Time.deltaTime * rotationSpeed);

            //this.gameObject.transform.forward = Vector3.Slerp(this.gameObject.transform.forward, orientation.forward.normalized, Time.deltaTime * rotationSpeed);
        }
