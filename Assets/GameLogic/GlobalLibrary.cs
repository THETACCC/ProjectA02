...
public static class GlobalLibrary
{
    ...
    public static readonly Dictionary<SceneTitle, SceneSpecifics> G_SCENE_SPECIFICS = new Dictionary<SceneTitle, SceneSpecifics>()
    {
        ...
        */
        ...
        {SceneTitle.Chapter2_0, new SceneSpecifics()
        {


        }},
        {SceneTitle.Chapter2_1, new SceneSpecifics()
        {


        }},
        {SceneTitle.Chapter2_2, new SceneSpecifics()
        {


        }},
        {SceneTitle.Chapter2_3, new SceneSpecifics()
        {


        }},
        {SceneTitle.Chapter2_4, new SceneSpecifics()
        {


        }},
        {SceneTitle.Chapter2_5, new SceneSpecifics()
        {
    ...
    public static readonly Dictionary<SceneCategory, SceneTitle[]> G_SCENE_CATEGORY_DICT = new Dictionary<SceneCategory, SceneTitle[]>
    {
        ...
        {SceneCategory.Chapter2, new SceneTitle[]{  SceneTitle.Chapter2_Test,  SceneTitle.Chapter2_4x4Test,  SceneTitle.Chapter2_0,  SceneTitle.Chapter2_1,  SceneTitle.Chapter2_2, SceneTitle.Chapter2_3, SceneTitle.Chapter2_4, SceneTitle.Chapter2_5   }}
    ...
    public static readonly Dictionary<SceneTitle, string> G_SCENE_ASSET_NAME = new Dictionary<SceneTitle, string>()
    {
        ...
        */
        ...
        {SceneTitle.Chapter2_1, "Chapter2_1" },
        {SceneTitle.Chapter2_2, "Chapter2_2" },
        {SceneTitle.Chapter2_3, "Chapter2_3" },
        {SceneTitle.Chapter2_4, "Chapter2_4" },
        {SceneTitle.Chapter2_5, "Chapter2_5" },
